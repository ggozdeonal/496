    ...
    <AccountContext.Provider value={contextValue}>
      <BoxContainer>
        <TopContainer>
          ...
          {active === "signin" && (
            <HeaderContainer>
              <HeaderText>BauPhi'ye Hoşgeldiniz</HeaderText>
              <SmallText>Lütfen devam etmek için giriş yapınız!</SmallText>
            </HeaderContainer>
          )}
          {active === "signup" && (
            <HeaderContainer>
              ...
              <SmallText>Lütfen devam etmek için üye olunuz!</SmallText>
            </HeaderContainer>
          )}
        </TopContainer>
        <InnerContainer>
